...
public class Peperoni extends AppCompatActivity {
    ...
    String m="";
    int cena=1;
    int cm=350;int cv=750;
    String imePrezime="",adresa="",telefon="",napomena="",kolicina="",tip="PEPERONI";
    ...
    public void setMessage(View view){
        ...
        if(isCheckedMala==false && isCheckedVelika==false){
            Toast.makeText(Peperoni.this, "Morate odabrati velicinu!", Toast.LENGTH_SHORT).show();
        }
        else if(isCheckedMala==true && isCheckedVelika==true){
            Toast.makeText(Peperoni.this, "Morate odabrati SAMO 1 velicinu!", Toast.LENGTH_SHORT).show();
        }
        if(imePrezime.matches("")){
            Toast.makeText(Peperoni.this, "Popuni polje ime!", Toast.LENGTH_SHORT).show();
        }
        if(adresa.matches("")){
            Toast.makeText(Peperoni.this, "Popuni polje adresa!", Toast.LENGTH_SHORT).show();
        }
        if(telefon.matches("")){
            Toast.makeText(Peperoni.this, "Popuni polje telefon!", Toast.LENGTH_SHORT).show();
        }
        if(kolicina.matches("0")){
            Toast.makeText(Peperoni.this, "Morate naruciti bar 1 picu!", Toast.LENGTH_SHORT).show();
        }
        ...
        if(!imePrezime.matches("") && !adresa.matches("") && !telefon.matches("") && !kolicina.matches("0") && (isCheckedMala==true || isCheckedVelika==true)){
            ...
            Toast.makeText(Peperoni.this, "Mozete naruciti!", Toast.LENGTH_LONG).show();
